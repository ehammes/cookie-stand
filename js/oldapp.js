// This is my old code from lab06
...
//Display the values of each array as unordered lists in the browser. Collaborated with Katharine, Vinny, and Guy
...
h2.textContent = seattle.locationName;
...
for (let i = 0; i < 15; i++) {
  ...
  ul.appendChild(li);
  li.textContent = hrArray[i] + seattle.getRandomCookiesPerHour[0][0+i][1] + ' cookies';
}
